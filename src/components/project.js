        ...
        <section id="projects">
            ...
            <div className="container">
                <div className="row m-3">
                    <a href="https://github.com/jchen2190" target="_blank" rel="noopener noreferrer"><img src={project3} class="img-fluid" alt="project1 screenshot" /></a>
                ...
                <div className="row m-3">
                    <a href="https://github.com/jchen2190" target="_blank" rel="noopener noreferrer"><img src={project3} class="img-fluid" alt="project2 screenshot" /></a>
                    <div className="col-xs-1 col-sm m-3">
                        <h4>Project 2</h4>
                ...
                <div className="row m-3">
                    <a href="https://weatherapp-2dyu.onrender.com" target="_blank" rel="noopener noreferrer"><img src={project3} class="img-fluid" alt="project3 screenshot" /></a>
                    <div className="col-xs-1 col-sm m-3">
                        <h4>WeatherApp</h4>
